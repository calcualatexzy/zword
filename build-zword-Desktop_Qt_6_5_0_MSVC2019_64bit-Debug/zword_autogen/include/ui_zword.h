...
public:
    ...
    void setupUi(QMainWindow *zword)
    {
        ...
        textEdit->setGeometry(QRect(0, 20, 791, 521));
        ...
        toolBar = new QToolBar(zword);
        toolBar->setObjectName("toolBar");
        zword->addToolBar(Qt::TopToolBarArea, toolBar);
    ...
    void retranslateUi(QMainWindow *zword)
    {
        ...
        toolBar->setWindowTitle(QCoreApplication::translate("zword", "toolBar", nullptr));
    } // retranslateUi
